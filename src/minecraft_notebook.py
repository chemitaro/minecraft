...
def safe_teleport(position: List) -> None:
    ...
    goal_x = position[0]
    goal_z = position[2]
    distance_x = goal_x - start_x
    distance_z = goal_z - start_z
